...
target "kafka-3_6" {
  ...
  tags = [
    "${IMAGE_WITH_REGISTRY}:3.6.2",
    "${IMAGE_WITH_REGISTRY}:v3.6.2",
...
target "kafka-3_7" {
  ...
  tags = [
    "${IMAGE_WITH_REGISTRY}:3.7.1",
    "${IMAGE_WITH_REGISTRY}:v3.7.1",
  ]
}
...
target "kafka-3_9" {
  ...
  tags = [
    "${IMAGE_WITH_REGISTRY}:3.9.0",
    "${IMAGE_WITH_REGISTRY}:v3.9.0",
  ]
}
